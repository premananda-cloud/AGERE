"""
PARKED — SITL/PX4 transplant phase, not the active training track.

Model-building now happens against gym-pybullet-drones (see
src/environments/pybullet/). This file is kept, not deleted, for when the
trained policy gets transplanted onto PX4 SITL and eventually real
hardware. It has not been re-tested since being parked; the 2026-07-23
session's unresolved MAVSDK connection issue was never confirmed fixed.
